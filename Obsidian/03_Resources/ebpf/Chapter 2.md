...
But in case of "always_inline", there is no jump instruction, instead of a copy of the function's instructions is emitted directly within the calling function.
